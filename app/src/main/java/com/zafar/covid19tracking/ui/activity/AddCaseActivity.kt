...
//    private val countriesList = ArrayList<String>()
...
//    val statesHashmap: HashMap<String, String> = HashMap()
//    var selectedState: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnAddCase.setOnClickListener {
            ...
            if (area.isEmpty()) {
                Toast.makeText(this@AddCaseActivity, getString(R.string.error_field_required), Toast.LENGTH_SHORT)
                    .show()
            ...
            val case = CaseDetails()
            case.area = area
            case.active = active
            case.recovered = recovered
            case.death = death
            viewModel.addCase(case)
        }
    }
